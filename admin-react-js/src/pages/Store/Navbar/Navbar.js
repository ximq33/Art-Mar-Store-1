                        ...
                        <div className="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul className="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                                <li className="nav-item"><a className="nav-link active" aria-current="page"
                                                            href="src/pages/Store/Navbar#!">Home</a>
                                </li>
                                <li className="nav-item"><a className="nav-link"
                                                            href="src/pages/Store/Navbar#!">About</a></li>
                                <li className="nav-item dropdown">
                                    <a className="nav-link dropdown-toggle" id="navbarDropdown"
                                       href="src/pages/Store/Navbar#" role="button"
                                       data-bs-toggle="dropdown" aria-expanded="false">Shop</a>
                                    <ul className="dropdown-menu" aria-labelledby="navbarDropdown">
                                        <li><a className="dropdown-item" href="src/pages/Store/Navbar#!">All
                                            Products</a></li>
                                        <li>
                                            <hr className="dropdown-divider"/>
                                        </li>
                                        <li><a className="dropdown-item" href="src/pages/Store/Navbar#!">Popular
                                            Items</a></li>
                                        <li><a className="dropdown-item" href="src/pages/Store/Navbar#!">New
                                            Arrivals</a></li>
                                    </ul>
                                </li>
                            </ul>
